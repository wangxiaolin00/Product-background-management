...
import { reqProducts, reqProductsSearch, reqUpdateStatus } from "../../network/index";
...
export default class Home extends Component {
  ...
  render() {
    ...
    const extra = <Button type="primary" onClick={() => { this.props.history.push('/product/addupdate') }}>添加</Button>;
